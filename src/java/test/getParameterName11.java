...
public class getParameterName11 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse resp) throws ServletException, IOException {
        ...
        while (paramNames.hasMoreElements()) {
            ...
            resultArrays = Arrays.copyOf(resultArrays,releng);
            resultArrays[releng-1] = Arrays.toString(allValues); 
